...
def startJvm():
    import os
    #os.environ.setdefault("STANFORD_PARSER_HOME", "/home/amelub/libs/stanford-parser-python-r22186/3rdParty/stanford-parser/stanford-parser-2010-08-20")
...
class Parser:
    ...
    #         self.javaHome = '/usr/lib/jvm/java-8-oracle' # Ubuntu linux
